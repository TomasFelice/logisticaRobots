...
public class Planificador { //lo está haciendo tomi
    ...
    public Planificador(RedLogistica redLogistica) {
...
//        }
    ...
    private boolean estanConectados(Punto a, Punto b) {
        // Verificar si ambos están en la cobertura de al menos un robopuerto común
//        for (Robopuerto robopuerto : redLogistica.getRobopuertos()) {
//            if (robopuerto.estaEnCobertura(a) && robopuerto.estaEnCobertura(b)) {
//                return true;
//            }
//        }
        return false;
